...
`C code <https://github.com/ar4/agdeblend/blob/main/examples/example_2.c>`_, `Python code <https://github.com/ar4/agdeblend/blob/main/examples/example_2.py>`_, `Julia code <https://github.com/ar4/agdeblend/blob/main/examples/example_2.jl>`_, `Fortran code <https://github.com/ar4/agdeblend/blob/main/examples/example_2.f90>`_
